...
/**
 * Internal function to transform a rpgcoin address buffer
 *
 * @param {Buffer} buffer - An instance of a hex encoded address Buffer
 ...
 *
 * The addresses will be sorted lexicographically, as that is the trend in rpgcoin.
...
/**
 * Internal function to transform a rpgcoin address string
 *
 * @param {string} data
 * @param {String|Network=} network - either a Network instance, 'livenet', or 'testnet'
 * @param {string=} type - The type: 'pubkeyhash' or 'scripthash'
 ...
 *
 * @param {string} str - An string of the rpgcoin address
 * @param {String|Network=} network - either a Network instance, 'livenet', or 'testnet'
 * @param {string=} type - The type of address: 'script' or 'pubkey'
 * @returns {Address} A new valid and frozen instance of an Address
 */
 ...
 *
 * @returns {Buffer} rpgcoin address buffer
 */
 ...
 *
 * @returns {string} rpgcoin address
 */

...
var HDPrivateKey = rpgcore.HDPrivateKey;
var HDPublicKey = rpgcore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = rpgcore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(rpgcore.crypto.BN.prototype, 'toBuffer', function(args) {
      ...
      sandbox.spy(rpgcore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      rpgcore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = rpgcore.PublicKey.fromPoint;
      rpgcore.PublicKey.fromPoint = function() {
        rpgcore.PublicKey.fromPoint = unstubbed;

...
var validbase58 = require('./data/rpgd/base58_keys_valid.json');
var invalidbase58 = require('./data/rpgd/base58_keys_invalid.json');
...
describe('Address', function() {
  ...
  describe('rpgd compliance', function() {
  ...
  describe('encodings', function() {
    ...
    it('should error because of unrecognized data format', function() {
      ...
      }).should.throw(rpgcore.errors.InvalidArgument);
    });
  ...
  describe('#object', function() {
    ...
    it('will fail with invalid state', function() {
      ...
      }).to.throw(rpgcore.errors.InvalidState);
    });
  });

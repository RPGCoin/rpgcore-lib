...
var script_valid = require('../data/rpgd/script_valid');
var script_invalid = require('../data/rpgd/script_invalid');
var tx_valid = require('../data/rpgd/tx_valid');
var tx_invalid = require('../data/rpgd/tx_invalid');

//the script string format used in rpgd data tests
Script.fromrpgdString = function(str) {
...
describe('Interpreter', function() {
  ...
  var testFixture = function(vector, expected) {
    var scriptSig = Script.fromrpgdString(vector[0]);
    var scriptPubkey = Script.fromrpgdString(vector[1]);
  ...
  describe('rpgd script evaluation fixtures', function() {
  ...
  describe('rpgd transaction evaluation fixtures', function() {
      ...
      set.forEach(function(vector) {
        ...
        it('should pass tx_' + (expected ? '' : 'in') + 'valid vector ' + cc, function() {
          ...
          inputs.forEach(function(input) {
            ...
            if (txoutnum === -1) {
              txoutnum = 0xffffffff; //rpgd casts -1 to an unsigned int
            }
            map[txid + ':' + txoutnum] = Script.fromrpgdString(scriptPubKeyStr);
          });
